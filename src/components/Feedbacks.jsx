...
const FeedBackCard = ({
  ...
  >
    ...
    <div className="mt-1 flex-1">
      {" "}
      {/* Added flex-1 here to ensure that this div takes up all available space */}
      <p className="text-white tracking-wider text-[18px] pb-5">
        {testimonial}
      </p>
    </div>
    <div className="mt-7 flex justify-between items-center gap-1 mt-auto">
      {" "}
      {/* Added mt-auto here */}
      ...
      <div className="mt-12 bg-black rounded-[20px]">
        ...
        >
          <motion.div variants={textVariant()}>
            ...
            <h2 className={styles.section2HeadText}>Recommendations.</h2>
          </motion.div>
        </div>
...
export default SectionWrapper(Feedbacks, "kudos");
